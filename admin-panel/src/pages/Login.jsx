...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row font-sans bg-slate-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#144474] to-[#0f345a] text-white relative overflow-hidden">
        
        {/* Abstract Geometric Pattern */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2"></div>
          <div className="absolute bottom-0 left-0 w-80 h-80 bg-blue-300/10 rounded-full translate-y-1/2 -translate-x-1/2"></div>
          <div className="absolute top-1/2 left-1/2 w-64 h-64 border border-white/10 rounded-2xl transform -translate-x-1/2 -translate-y-1/2 rotate-12"></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 h-full w-full">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center shadow-lg">
              <span className="text-[#144474] font-bold text-xl">L</span>
            </div>
            <span className="text-xl font-bold tracking-wide">KnowLiberia ADMIN</span>
          </div>

          {/* Main Pitch */}
          <div className="max-w-lg">
            <h1 className="text-5xl font-extrabold leading-tight mb-6">
              Manage Your Properties <span className="text-blue-200">Effortlessly.</span>
            </h1>
          ...
          <div className="flex gap-8">
            <div>
              <p className="text-3xl font-bold">10k+</p>
              <p className="text-xs text-blue-200 uppercase tracking-wider">Listings</p>
            </div>
            <div>
              <p className="text-3xl font-bold">98%</p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 relative">
        ...
        <div className="absolute top-0 right-0 w-64 h-64 bg-blue-100 rounded-full filter blur-3xl opacity-40"></div>

        <div className="relative z-10 w-full max-w-md">
          
          {/* Mobile Logo */}
          <div className="lg:hidden text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-[#144474] rounded-2xl shadow-lg mb-4">
              <span className="text-white font-bold text-3xl">L</span>
            </div>
            <h1 className="text-2xl font-bold text-gray-800">KnowLiberia ADMIN</h1>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-xl p-8 md:p-10 rounded-3xl shadow-2xl border border-white/50">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className="w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#144474]/20 focus:border-[#144474] transition-all duration-200"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full bg-[#144474] text-white font-bold py-3.5 px-4 rounded-xl shadow-lg shadow-blue-100 hover:bg-[#0f345a] focus:outline-none focus:ring-2 focus:ring-[#144474] focus:ring-offset-2 transition-all duration-300 transform hover:-translate-y-0.5 ${loading ? 'opacity-80' : ''}`}
              >
                {loading ? (
                  <div className="flex items-center justify-center gap-2">
                    <svg className="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
