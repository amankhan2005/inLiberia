        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span>Response time: <span className="font-semibold text-red-600">2-4 hours</span></span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-xl p-6 text-white">
              ...
              <p className="text-red-100 text-sm mb-4">Call our support team for urgent issues</p>
              <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onBlur={() => setFocusedField('')}
                        className={`w-full pl-10 pr-3 py-3 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all ${
                          focusedField === 'phone' ? 'border-red-500 shadow-sm' : 'border-gray-300'
                        }`}
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        onBlur={() => setFocusedField('')}
                        className={`w-full px-3 py-3 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all resize-none ${
                          focusedField === 'query' ? 'border-red-500 shadow-sm' : 'border-gray-300'
                        }`}
                        required
                      />
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1 relative">
                        <input
                          ...
                          onBlur={() => setFocusedField('')}
                          className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all ${
                            focusedField === 'captcha' ? 'border-red-500 shadow-sm' : 'border-gray-300'
                          } ${form.captcha && !captchaCorrect ? 'border-red-500 bg-red-50' : ''}`}
                          required
                        />
                        {form.captcha && (
