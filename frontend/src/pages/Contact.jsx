...
"2101 St Paul St, 1st Fl Baltimore MD 21218";
  ...
  return (
    ...
    <main className="bg-gradient-to-br from-sky-50 via-white to-orange-50 py-28 font-[Poppins]">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-[#F39C6B] font-semibold mb-3 tracking-wide">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 mb-5 leading-tight">
            ...
            <span className="font-serif text-[#38bdf8]">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            ...
            We’re here to support your healthcare needs with compassion and professional care.
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <div className="w-12 h-12 bg-gradient-to-r from-[#F39C6B] to-[#38bdf8] rounded-xl flex items-center justify-center">
          ...
          <div className="lg:col-span-2 bg-white rounded-3xl p-10 shadow-2xl border">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className="w-full bg-[#38bdf8] text-white py-4 rounded-xl font-semibold flex justify-center gap-2 hover:opacity-90 transition disabled:opacity-60"
